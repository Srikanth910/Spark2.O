  ...
  return async dispatch => {
    try {
     ...
     //  });
      ...
      const res = await axios.get(`${API_URL}/getBeneficiaryV_1_3_5?membarId=${data.membarId}&isPrimaryAccunt=${data.isPrimaryAccunt}&isWithInCoop=${data.isWithInCoop}&type=${data.type}`)

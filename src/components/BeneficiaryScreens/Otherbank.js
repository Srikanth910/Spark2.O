...
import {
  resendOtpBeneficiary,
  addBeneficiaryDetails,
  createOtpBeneficiary,
} from '../../Redux/actions/Beneficiary';
          ...
          <ScrollView>
            ...
            <Item regular style={styles.Inputstyle}>
              <Input
                ...
                onChangeText={Accounttext =>
                  this.setState({AccontNo: Accounttext})
                }
              />
            </Item>
            ...
            <Item regular style={styles.Inputstyle}>
              <Input
                ...
                onChangeText={Accounttext =>
                  this.setState({ConfirmAccontNo: Accounttext})
                }
              />
            </Item>
            ...
            <Text style={styles.textstyle}>
              Please ensure you enter the correct account details.Spark is not
              responsible for incorrect account details
            </Text>
            ...
            <View>
              <Modal
                ...
                isVisible={this.state.otpvisible}>
                <View style={{backgroundColor: 'white'}}>
                  ...
                  <ListItem style={{justifyContent: 'flex-end'}}>
                    <Text style={styles.cancel} onPress={this.toggelopen}>
                      Cancel
                    </Text>
              ...
              <Modal
                ...
                <View style={{backgroundColor: 'white'}}>
                  ...
                  <ListItem style={{justifyContent: 'flex-end'}}>
                    ...
                    <Text style={styles.otpSubmit} onPress={this.addSubmit}>
                      Ok
                    </Text>
                  </ListItem>
                </View>
...
export default connect(
  mapStateToProps,
  {resendOtpBeneficiary, addBeneficiaryDetails, createOtpBeneficiary},
)(Otherbank);

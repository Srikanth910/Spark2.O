            ...
            <Modal
              ...
              <View style={{backgroundColor: 'white'}}>
                <Text
                  ...
                  onPress={() =>
                    this.props.navigation.navigate('AddBeneficiarys')
                  }>
                  Add Spark member as beneficiary
                </Text>
                <Text
                  style={styles.otpText}
                  onPress={() => this.props.navigation.navigate('Otherbank')}>
                  Add a bank account as beneficiary
                </Text>
        ...
        <Tabs tabBarUnderlineStyle={{backgroundColor: '#f3a549'}}>
          <Tab
            ...
            <Image
              ...
              source={require('../../images/spark_ben.png')}
              style={{height: 450, width: 255, left: 70, bottom: -50}}
            />

            {getBeneficiary.array&& getBeneficiary.array.map(data=>{

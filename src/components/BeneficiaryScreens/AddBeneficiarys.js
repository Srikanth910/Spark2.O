        ...
        <Tab
          ...
          <ScrollView>
            ...
            <Text style={styles.StateText}>
              Please select the Co-operative that the Beneficiary you want to
              add is a member of.
            </Text>
            ...
            {this.state.name === 'SavingsAccount' && (
              <View>
                ...
                <Text style={styles.StateText}>
                  Re-Enter beneficiary phone number
                </Text>
            ...
            {this.state.name === 'false' && (
              <View>
                <Text style={styles.StateText}>
                  Enter beneficiary Business Account ID
                </Text>
                <Item regular style={styles.Inputstyle}>
                  <Input
                    placeholder=""
                ...
                <Text style={styles.StateText}>
                  Re-Enter beneficiary Business Account ID
                </Text>
                <Item regular style={styles.Inputstyle}>
                  <Input
                    placeholder=""
            ...
            <Text style={styles.StateText}>
              Please ensure you have entered the correct account details.Spark
              is not responsible for incorrect details.
            </Text>
              ...
              <Modal
                ...
                <View style={{backgroundColor: 'white'}}>
                  ...
                  <ListItem
                    ...
                    <Text>2:00.0</Text>
                    <Text style={styles.resendOtp} onPress={this.redatasubmit}>
                      Resend OTP
                    </Text>
                  </ListItem>
                  <ListItem style={{justifyContent: 'flex-end'}}>
                    <Text style={styles.cancel} onPress={this.toggleClose}>
                      Cancel
                    </Text>
                    <Text style={styles.otpSubmit} onPress={this.changepage}>
                      Submit
                    </Text>
                  </ListItem>
                </View>

            ...
            <Container style={styles.Container}>
                ...
                <Content >
                    ...
                    <ListItem style={styles.listview}>
                        ...
                        <Image source={require('../../images/rupi_icon.png')} style={{ width:8, height:16,alignSelf: 'center', marginLeft:120}} />
                        <Body>
                    ...
                    <ListItem style={styles.listview}>
                        <Image source={require('../../images/faq.png')} style={{ width: 16, height: 16, alignSelf: 'center', }} />
                        <Body>
                            <Text style={styles.Listtext}> Please Add a Bank Account in order to transfer</Text>

...
import { Container, Header, Content, Button, View, ListItem, Icon, } from 'native-base'
import { StatusBar, Text, StyleSheet, Image, ImageBackground, TouchableOpacity } from 'react-native'
import { ScrollView } from 'react-native-gesture-handler'
import Modal from 'react-native-modal';
import SmoothPinCodeInput from 'react-native-smooth-pincode-input'
export default class Transfer_Otherbank_confirm extends Component {
      constructor(props) {
          super(props)
 ...
 const{mobileOtp}=this.state
        return (
            <Container>
                ...
                <ImageBackground source={require('../../../images/home/confirm_bg.png')} style={{ height: '100%', width: '100%' }} >
                <StatusBar barStyle="light-content" backgroundColor="#1b1464" />



                <View style={{flexDirection:"row",  flex:1, alignItems:'center',justifyContent:'space-around' ,marginVertical: 30,}}>
...
<ListItem style={{ justifyContent: 'flex-end' }} >
  ...
  <TouchableOpacity>
   ...
   onPress={()=>this.props.navigation.navigate('Transfer_Otherbank_Success')}
    >Submit</Text>

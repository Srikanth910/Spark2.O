                    ...
                    <View style={{ flexDirection: "row", justifyContent: 'space-between', marginHorizontal: 16, marginVertical: 16 }}>
                        ...
                        <Button bordered warning style={styles.btnborder}
                          onPress={()=>this.handleschedule('oneTime','1')}
                            style={this.state.activeIndex==='1'?styles.btnActive:styles.btnborder}
                         >
                            <Text style={styles.btntext}
                             style={this.state.activeIndex==='1'?styles.btntextcolor:styles.btntext}
                            >One Time</Text>
                        </Button>
                        <Button bordered warning style={styles.btnborder}
                        onPress={()=>this.handleschedule('weekly','2')}
                        style={this.state.activeIndex==='2'?styles.btnActive:styles.btnborder}
                        >
                            <Text style={styles.btntext}
                             style={this.state.activeIndex==='2'?styles.btntextcolor:styles.btntext}
                            
                            >Weekly</Text>
                        </Button>
                        <Button bordered warning style={styles.btnborder}
                        onPress={()=>this.handleschedule('monthly','3')}
                        style={this.state.activeIndex==='3'?styles.btnActive:styles.btnborder}
                        >
                            <Text style={styles.btntext}
                             style={this.state.activeIndex==='3'?styles.btntextcolor:styles.btntext}
                            >Monthly</Text>
                        </Button>
                    </View>
...
<Image source={require('../../images/Transfer/schedule_img.png')}/>
</View>}

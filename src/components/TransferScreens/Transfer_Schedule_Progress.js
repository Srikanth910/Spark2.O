...
export default class Schedule_Progress extends Component {
  render() {
    ...
    return (
      <Container>
        <ImageBackground
          source={require('../../images/home/progress_bg.png')}
          style={{height: '100%', width: '100%', flex: 0.7, bottom: 0}}>
          <StatusBar barStyle="light-content" backgroundColor="#fbbe05" />

          <ListItem style={styles.listview}>
            <Image
              source={require('../../images/Transfer/up_arrow.png')}
              style={{marginLeft: 330, marginTop: 0}}
            />

            <Body>
              <Image
                source={require('../../images/Transfer/help_icon.png')}
          ...
          <ListItem
            ...
            <Left>
              <Image
                ...
                source={require('../../images/Transfer/logo_s.png')}
              />
            </Left>
                ...
                <View style={{marginHorizontal: 23}}>
                    ...
                    <ListItem style={{borderColor: 'transparent'}}>
                      ...
                      <View style={{paddingLeft: 30}}>
                        ...
                        <Text style={styles.curdtext}>
                          Account ID{' '}
                          <Text style={styles.moneytext}> {params.accNo}</Text>
                        </Text>

                        <Text style={styles.curdtext}>
                          IFSC code <Text style={styles.moneytext}> </Text>
                        </Text>
                      </View>
                    </ListItem>
                  </View>
                  ...
                  <View style={styles.curd_user}>
                    ...
                    <ListItem style={styles.listview}>
                      ...
                      <Body>
                        <Text style={styles.textdetails}>
                          {params.scheduledays},0/48 transfers done
                        </Text>
                      </Body>
                    </ListItem>
                  </View>

...
class FDCloseSuccessScreen extends Component{
    ...
    render(){
      ...
      <ScrollView style={{backgroundColor:'#F0F0FF'}}>
          ...
          <View style={styles.header}>
              ...
              <Text style={styles.title}>Fixed Deposit closed</Text>
              <Image style={{height:100,width:60,marginTop:-40}}
              resizeMode = {'center'}
               source={require('../../images/fd&rd/fdClose.png')}></Image>
              </List>
...
<Text style={styles.smallAmount}>0.5% + Rs. 100 </Text>
          ...
          <View style={styles.divider}></View>
          <Text style={styles.content}>We are sorry to see this Fixed Deposit closed. We understand you may have some urgent commitments to honour. Please do come back and avail another Deposit in the future. We keep working to give you the best and most transparent rates in our products.</Text>
          </View>
          </View>
          <View style={styles.seperator}></View>
          </SafeAreaView>
...
export default FDCloseSuccessScreen;

...
UIManager.setLayoutAnimationEnabledExperimental &&
 ...
 class cloneFD extends Component{
...
justifyContent:'space-between'}}>
  ...
  <ImageBackground style={{position: 'absolute',left:0,right: 0,top:50,bottom:0,overflow:false}} source = {require('../../images/fd&rd/blueSky.png')}></ImageBackground>
...
style={{height:this.state.sheetHeight * 0.2,
  width:width,
  marginVertical:16}}
  source = {require('../../images/fd&rd plane.png')}>
</Image>
...
<Button transparent>
    <Text style = {{color:'#f59c34'}}>
        Change
    </Text>
</Button>
</View>
<Button style={{backgroundColor:'#f7931e',
marginHorizontal:16,
marginBottom:24,

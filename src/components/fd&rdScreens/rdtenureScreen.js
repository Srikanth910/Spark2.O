...
import {View,Dimensions,Text, StyleSheet,TextInput, Slider, FlatList,Switch} from  'react-native';
...
class RDTenureScreen extends React.Component{
    ...
    render(){
        return (
            ...
            This option allows you to break the deposit before maturity at appropriately readjusted interest rates. Average exit load is low at {this.state.minNonBreakInterest}%.     
                                 </Text>

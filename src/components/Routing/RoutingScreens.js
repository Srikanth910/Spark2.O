      ...
      <Stack.Navigator
        ...
        {props.auth.isAutherticated === false ? (
          ...
          <>
            ...
            <Stack.Screen
              name="Loadmoneyprogress"
              component={Loadmoneyprogress}
            />
            <Stack.Screen
              name="LoadmoneySuccess"
              component={LoadmoneySuccess}
            />
            ...
            <Stack.Screen
              name="To_spark_confirm"
              component={To_spark_confirm}
            />

          
            <Stack.Screen
              name="Schedule_Progress"
              component={Schedule_Progress}
            />

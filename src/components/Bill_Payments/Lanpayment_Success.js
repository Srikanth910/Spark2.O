          ...
          <ListItem style={{borderColor: 'transparent'}}>
            ...
            <View style={{marginLeft: 40}}>
              <Item style={{borderColor: 'transparent', alignSelf: 'center'}}>
                ...
                />
                <Text style={styles.headerbal}>24,000</Text>
              </Item>

              <Text style={styles.text}>Paying AEON CREDIT Mumbai</Text>
            </View>
          </ListItem>
                ...
                <View
                  ...
                  <View style={styles.fulldetails}>
                    ...
                    <ListItem thumbnail>
                      <Left>
                        <Image
                          source={require('../../images/billpay/Airtel.png')}
                        />
                      </Left>
                      <Body>
                    ...
                    <View style={{alignSelf: 'center', bottom: 10}}>
                      ...
                      <Text style={styles.textData}>
                        Loan Due date{' '}
                        <Text style={{textAlign: 'center'}}>10 June 2020</Text>
                      </Text>
                      <Text style={styles.textData}>
                        EMI Principal{' '}
                        <Text style={{textAlign: 'center'}}>10 June 2020</Text>
                      ...
                      <Text style={styles.textData}>
                        EMI Interest : <Text>10 June 2020</Text>
                      </Text>
                      <Text style={styles.textData}>
                        Total Out Standing : 0.00 0.00
                      </Text>
                      <Text style={styles.textData}>
                      ...
                      <Text style={styles.textData}>Payment mode : Cash</Text>
                    </View>

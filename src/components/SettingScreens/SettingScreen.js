  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Content>
            {params.kycstatus==="KYC verified"?
          <View style={styles.rectangle}>
            <View style={styles.reactangleText}>
              <Image source={require('../../images/spark_logo.png')} />
              <Text style={styles.rupi} />
    <Text style={styles.loaded}>Member ID: {userDetails.memberid}</Text>
              <Text style={styles.loaded}>{userDetails.mobileNo},</Text>
    <Text style={styles.loaded}>A/C no.:{params.acc}</Text>
              {/* <Text style={styles.loaded}>IFSC: YESB0CMSNOC</Text> */}
              <Text style={styles.user}>
                Karnataka, Ayshwarya Syndicate Souharda Credit Co-operative
                Limited
              </Text>
            </View>
          </View>:null}
          ...
          {params.kycstatus==="KYC verified"?null:
          ...
          <View style={styles.rectBox}>
            ...
            <List>
              ...
              <ListItem
                ...
                <Left>
                  <Image
                    source={require('../../images/beneficiary.png')}
                    style={{marginTop: 8}}
                  />
          ...
          <View style={styles.settingsrectBox2}>
            ...
            <List>
              <ListItem
                style={{justifyContent: 'center', alignItems: 'center'}}
                onPress={() =>
                  this.props.navigation.navigate('ChangePasseword')
                }>
                <Left>
              ...
              <ListItem
                ...
                <Left>
                  <Image
                    source={require('../../images/passcode.png')}
                    style={{marginTop: 6}}
                  />
              ...
              <ListItem
                ...
                <Left>
                  ...
                  <Text style={styles.list_item}>
                    Allow login using Phone Unlock
                  </Text>
                </Left>
                <Right>
                  <Switch />
